...
172.20.20.3/32     *[IS-IS/18] 00:51:45, metric 20
                    > to 10.0.0.6 via ge-0/0/1.0
```
Nice! Полагаю, Вам стало яснее, что есть Batfish.
...
## Сonclusion
На мой взгляд, Batfish - это мощнейщий инструмент с огромным потенциалом. Но, к сожалению, его функционал пока еще далек от совершенства - отсутствует поддержка MPLS, Layer2 technologies etc. Если данная тема Вам интересна - присоединяйтесь в slack чат, разработчики Batfish с удовольсвтием отвечают на любые вопросы и быстро правят баги.
